...
const alertLabel = (type: string) => type === 'Accident' ? 'Accident Detected' : type === 'Rash driving' ? 'Rash Driving Detected' : type === 'Pothole' ? 'Pothole Detected' : type === 'Pedestrian safety' ? 'Pedestrian Safety Risk' : type;
    ...
    <div className="login-screen">
      <div className="login-panel">
        ...
        <div className="login-heading">
          ...
          <p>Old Delhi–Badli corridor · restricted access</p>
        </div>
        ...
        <p className="login-footer">Delhi Traffic Police · Transport Department access only</p>
      </div>
    </div>
  );
}
...
export function Overview({ data, liveBuses, onSelect, onRunDemo, simulating, simulateError }: { data: DashboardData; liveBuses: LiveBusState; onSelect:(event:UrbanEvent)=>void; onRunDemo:(file: File)=>void; simulating?: boolean; simulateError?: string | null }) {
  ...
  return <>
    <div className="page-heading">
      ...
      <input ref={fileInputRef} type="file" accept="video/mp4,video/quicktime,video/x-msvideo,image/jpeg,image/png" hidden onChange={handleFile}/>
    </div>
